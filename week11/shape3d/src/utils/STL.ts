// STL.ts — Mirrors STL.cpp / STL.h
// Load and save ASCII STL files in the browser.

export class STL {
  /** Parse ASCII STL text → flat float array [x,y,z, ...] (9 floats per triangle) */
  ...
  /** Trigger browser file-open dialog, return flat float array */
  ...
  /** Trigger browser file-save (download) of ASCII STL */
